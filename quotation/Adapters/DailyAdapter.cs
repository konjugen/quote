...
{
    public class DailyAdapter : RecyclerView.Adapter
    {
        private DailyActivity dailyActivity;
        private RecyclerView listViewDaily;
        private List<WriterItem> items = new List<WriterItem>();

        public DailyAdapter(DailyActivity dailyActivity, RecyclerView listViewDaily)
        {
            this.dailyActivity = dailyActivity;
            this.listViewDaily = listViewDaily;
        }
